...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        simpleItem(ModItems.CEMENTED_CALCITE);
        simpleItem(ModItems.CEMENTED_HEMATITE);
        simpleItem(ModItems.CEMENTED_METACONGLOMERATE);
        simpleItem(ModItems.CEMENTED_SIDERITE);
        simpleItem(ModItems.CEMENTED_SILICA);
